...
traj_interp = struct( ...
    't', num2cell(t), ...
    'x', mat2cell(x', size(x,2), ones(1,N)), ...
    'v', mat2cell(v', size(v,2), ones(1,N)), ...
    'a', mat2cell(a', size(a,2), ones(1,N)), ...
    'des_states', mat2cell(des_states', size(des_states,2), ones(1,N)), ...
    'yaw_des', num2cell(yaw_des'));

%%
for k = 1:N-1
    [traj_interp, dhParams] = get_dhParams(traj_interp(k),terrain,params);
